...
namespace Cyh
{
    ...
    {
        class _MinMaxTuple<T> where T : IComparable
        {
        ...
        static _MinMaxTuple<T> _Get_MinMax<T>(T? lhs, T? rhs) where T : IComparable {
        ...
        public static bool IsChildOf(this Type? type,Type? other) {
            return type!=null&&other!=null && type.IsSubclassOf(other);
        }
